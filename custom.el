(custom-set-variables
 ...
 '(cider-font-lock-dynamically (quote (macro deprecated)))
 ...
 '(cider-repl-init-code
   (quote
    ("(do (clojure.core/apply clojure.core/require clojure.main/repl-requires) (in-ns 'boot.user))")))
...
:cljs [cljs.test :as t :include-macros true])")
 ...
 '(clojure-build-tool-files
   (quote
    ("build.boot" "project.clj" "deps.edn" "shadow-cljs.edn")))
 '(clojure-defun-indents
   (quote
    (set-content-view! on-ui transact fact facts fact-group)))
 '(clojure-omit-space-between-tag-and-delimiters (quote (91 123 40)))
 ...
 '(magit-visit-ref-behavior (quote (focus-on-ref create-branch checkout-any)))
 ...
 '(package-selected-packages
   (quote
    (undo-tree json-mode origami markdown-preview-mode helm-ag elm-mode go-mode git-gutter magit haskell-mode auto-package-update auto-yasnippet fireplace org-jira docker-tramp ac-cider company-flx java-snippets magit-gh-pulls gh sunrise-x-tabs sunrise-x-mirror sunrise-x-loop sunrise-x-checkpoints pcre2el openwith nlinum nginx-mode names lua-mode javap-mode inform7-mode ido-ubiquitous idle-highlight-mode htmlize highlight-symbol helm-swoop groovy-mode graphviz-dot-mode gradle-mode git-timemachine gist fill-column-indicator elisp-slime-nav dockerfile-mode company-quickhelp color-theme-sanityinc-tomorrow centered-window-mode base16-theme auctex)))
 '(pop-up-windows nil)
 ...
 '(whitespace-style (quote (face trailing tabs empty lines-tail)))
 '(yas/trigger-key "C-o"))
(custom-set-faces
 ...
 ;; Your init file should contain only one such instance.
 ;; If there is more than one, they won't work right.
 '(default ((t (:inherit nil :stipple nil :inverse-video nil :box nil :strike-through nil :overline nil :underline nil :slant normal :weight normal :height 130 :width normal :foundry "unknown" :family "Noto Mono"))))
